...
{
    return (Player1WinTimes > ComputerWinTimes) ? enWinner::Player1 : (ComputerWinTimes > Player1WinTimes) ? enWinner::Computer : enWinner::Draw;
}
...
{
    string arrWinnerNmae[3] = { "Player1","Computer","NO Winner (Draw)" };
